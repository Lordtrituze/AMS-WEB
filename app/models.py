...
class Aircraft(models.Model):
    ...
    def __str__(self):
        return f"{self.aircraft_name:<15}\t{self.aircraft_capacity:<10}"
...
class Passenger(models.Model):
    ...
    def __str__(self):
        return f"{self.user.first_name:<20}\t{self.user.last_name:<20}"
...
class Flight(models.Model):
    ...
    def __str__(self):
        return f"{self.aircraft:<5}\t{self.takeoff_location:<15}\t{self.destination:<15}\t{self.departure_date:<15}\t{self.arrival_time:<15} "
